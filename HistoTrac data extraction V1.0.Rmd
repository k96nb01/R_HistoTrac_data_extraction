---
title: "HistoTrac data extraction V1.0.rmd"
...
#This will show all of the tables in the HistoTrac database. 
```
...
con <- dbConnect(odbc::odbc(), "HistoTrac", timeout = 10)
(dtTransplantHistory <- dbReadTable(con, "TransplantHistory") %>% as_tibble)
...
#save Xmatch table
con <- dbConnect(odbc::odbc(), "HistoTrac", timeout = 10)
(dtXmatch <- dbReadTable(con, "Xmatch") %>% as_tibble)
...
con <- dbConnect(odbc::odbc(), "HistoTrac", timeout = 10)
(dtUserXmatch <- dbReadTable(con, "UserXmatch") %>% as_tibble)
